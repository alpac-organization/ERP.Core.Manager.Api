...
namespace ERP.Core.Manager.Api.Application.Commons.Interfaces
{
    public interface IIncomeServices
    {
        ...
        Task ApplyIncomeHoliday(Collaborator collaboratorInformation, Salary salaryInformation, decimal amountDays, decimal amountHours, Guid payrollId, Guid typeIncomeId);
    }
}