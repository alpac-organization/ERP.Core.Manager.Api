...
{
    public class CheckIfThereIsPayrollInProcessValidator: AbstractValidator<CheckIfThereIsPayrollInProgressQuery>
    {
        public CheckIfThereIsPayrollInProcessValidator()
        {
