...
{
    /// <inheritdoc />
    public partial class AgregarEntidadDeduccionesLey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:payroll_type_enum", "none,ordinary,provided")
                ...
                .OldAnnotation("Npgsql:Enum:payroll_type_enum", "none,ordinary,provided")
