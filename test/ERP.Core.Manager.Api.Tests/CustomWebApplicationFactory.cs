...
using ERP.Core.Manager.Api.Tests.Common.Services;
    ...
    public class CustomWebApplicationFactory : WebApplicationFactory<Program>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                // Reemplazar servicios externos para testing
        ...
        {
            //Usamos la imagen oficial de PostgreSQL 16-alpine para crear un contenedor de prueba.
            ...
            catch (Exception ex)
            {
                ...
                TestContext.Progress.WriteLine($"[Testcontainers] Intento levantar postgres:16-alpine falló: {ex.Message}");
            }
        }
